...
(LiveValidation.VERSION = "1.3 standalone eloqua-19A"),
    ...
    (LiveValidation.prototype = {
        ...
        initialize: function (e, i) {
            ...
            if (
                (a.isGroup
                    ? ((this.element = e), (this.form = this.element[0].form), (this.elementType = LiveValidation.GROUP))
                    : ((this.element = e.nodeName ? e : document.getElementById(e)), (this.form = this.element.form), (this.elementType = this.getElementType())),
                !this.element)
            )
                throw new Error("LiveValidation::initialize - No element with reference or id of '" + e + "' exists!");
            (this.validations = []), (this.validMessage = a.validMessage || "Thankyou!"), (this.isGroup = a.isGroup || !1);
            var n = a.insertAfterWhatNode || this.element;
            if (
                ((this.insertAfterWhatNode = n.nodeType ? n : document.getElementById(n)),
                (this.onValid =
                    a.onValid ||
                    function () {
                ...
                this.form && ((this.formObj = LiveValidationForm.getInstance(this.form)), this.formObj.addField(this)),
                ...
                (this.element.onfocus = function (e) {
                    return t.doOnFocus(e), t.oldOnFocus.call(this, e);
                }),
                !this.onlyOnSubmit)
            )
                    ...
                    default:
                        this.onlyOnBlur ||
                            (this.element.onkeyup = function (e) {
                                return t.deferValidation(), t.oldOnKeyup.call(this, e);
                            }),
        ...
        destroy: function () {
            if ((this.formObj && (this.formObj.removeField(this), this.formObj.destroy()), (this.element.onfocus = this.oldOnFocus), !this.onlyOnSubmit))
                switch (this.elementType) {
                    case LiveValidation.CHECKBOX:
        ...
        validateElement: function (e, i) {
            if (this.elementType == LiveValidation.SELECT) var t = -1 !== this.element.selectedIndex ? this.element.options[this.element.selectedIndex].value : "";
            ...
            try {
                ...
                ("" !== t || ("" === t && this.displayMessageWhenEmpty)) && ((this.validationFailed = !0), (this.message = e.message), (s = !1));
            } finally {
                return s;
            }
        },
        validate: function () {
            return !!this.element.disabled || (this.doValidations() ? (this.onValid(), !0) : (this.onInvalid(), !1));
        },
        enable: function () {
            ...
            if ((this.removeMessage(), (this.displayMessageWhenEmpty && (this.elementType == LiveValidation.CHECKBOX || "" == this.element.value)) || "" != this.element.value)) {
                ...
                (e.className += " " + this.messageClass + " " + i),
                    this.insertAfterWhatNode.nextSibling
                        ? this.insertAfterWhatNode.parentNode.parentElement.insertBefore(e, this.insertAfterWhatNode.parentElement.nextSibling)
                        : this.insertAfterWhatNode.parentNode.parentElement.appendChild(e);
            }
        },
        addFieldClass: function () {
            this.removeFieldClass(),
                this.validationFailed
                    ? this.isGroup
                        ? -1 == this.insertAfterWhatNode.parentElement.className.indexOf(this.invalidFieldClass) && (this.insertAfterWhatNode.parentElement.className += " " + this.invalidFieldClass)
                        : -1 == this.element.className.indexOf(this.invalidFieldClass) && (this.element.className += " " + this.invalidFieldClass)
                    : (this.displayMessageWhenEmpty || "" != this.element.value) &&
                      (this.isGroup
                          ? -1 == this.insertAfterWhatNode.parentElement.className.indexOf(this.invalidFieldClass) && (this.insertAfterWhatNode.parentElement.className += " " + this.validFieldClass)
                          : -1 == this.element.className.indexOf(this.validFieldClass) && (this.element.className += " " + this.validFieldClass));
        },
        ...
        removeFieldClass: function () {
            this.isGroup
                ? (-1 != this.insertAfterWhatNode.parentElement.className.indexOf(this.invalidFieldClass) &&
                      (this.insertAfterWhatNode.parentElement.className = this.insertAfterWhatNode.parentElement.className.split(this.invalidFieldClass).join("")),
                  -1 != this.insertAfterWhatNode.parentElement.className.indexOf(this.validFieldClass) &&
                      (this.insertAfterWhatNode.parentElement.className = this.insertAfterWhatNode.parentElement.className.split(this.validFieldClass).join(" ")))
                : (-1 != this.element.className.indexOf(this.invalidFieldClass) && (this.element.className = this.element.className.split(this.invalidFieldClass).join("")),
    ...
    (LiveValidationForm.prototype = {
        initialize: function (e) {
            ...
            this.element.onsubmit = function (e) {
                return !!LiveValidation.massValidate(i.fields) && !1 !== i.oldOnSubmit.call(this, e || window.event);
            };
        },
        addField: function (e) {
            this.fields.push(e);
        ...
        removeField: function (e) {
            for (var i = [], t = 0, a = this.fields.length; t < a; t++) this.fields[t] !== e && i.push(this.fields[t]);
            this.fields = i;
        },
        destroy: function (e) {
            return !(0 != this.fields.length && !e) && ((this.element.onsubmit = this.oldOnSubmit), !(LiveValidationForm.instances[this.name] = null));
        },
    });
var Validate = {
    ...
    Numericality: function (e, i) {
        var t = e,
            a = ((e = Number(e)), (i = i || {}).minimum || 0 == i.minimum ? i.minimum : null),
        ...
        switch ((isFinite(e) || Validate.fail(l), i.onlyInteger && (/\.0+$|\.$/.test(String(t)) || e != parseInt(e)) && Validate.fail(o), !0)) {
            case null !== s:
                e != Number(s) && Validate.fail(r);
                break;
            case null !== a && null !== n:
                Validate.Numericality(e, { tooLowMessage: d, minimum: a }), Validate.Numericality(e, { tooHighMessage: h, maximum: n });
                break;
            case null !== a:
    ...
    PhonenumberCheck: function(e, i) {
        e = String(e);
        var t = (i = i || {}).failureMessage || "Not valid!",
        return window.libphonenumber.phoneNumberParser(e).isValidNumber || Validate.fail(t);
    },
    Email: function (e, i) {
        var t = (i = i || {}).failureMessage || "Must be a valid email address!";
        return Validate.Format(e, { failureMessage: t, pattern: /^([^@\s]+)@((?:[-a-z0-9]+\.)+[a-z]{2,})$/i }), !0;
    },
    Length: function (e, i) {
        e = String(e);
        ...
        switch (!0) {
            case null !== n:
                ...
                break;
            case null !== t && null !== a:
                Validate.Length(e, { tooShortMessage: l, minimum: t }), Validate.Length(e, { tooLongMessage: o, maximum: a });
                break;
            case null !== t:
    ...
    Inclusion: function (e, i) {
        ...
        if (!a) {
            for (var s = [], l = 0, o = n.length; l < o; ++l) {
                var r = n[l];
                "string" == typeof r && (r = r.toLowerCase()), s.push(r);
            }
            (n = s), "string" == typeof e && (e = e.toLowerCase());
        }
        var d = !1,
            h = 0;
        for (o = n.length; h < o; ++h) n[h] == e && (d = !0), i.partialMatch && -1 != e.indexOf(n[h]) && (d = !0);
        return ((!i.negate && !d) || (i.negate && d)) && Validate.fail(t), !0;
    },
    Exclusion: function (e, i) {
        return ((i = i || {}).failureMessage = i.failureMessage || "Must not be included in the list!"), (i.negate = !0), Validate.Inclusion(e, i), !0;
    },
